...
def attack(char_name, char_class):
    if char_class == 'warrior':
        print(f'{char_name} нанёс урон противнику равный {5 + randint(3, 5)}')
    if char_class == 'mage':
        print(f'{char_name} нанёс урон противнику равный {5 + randint(5, 10)}')
    if char_class == 'healer':
        print(f'{char_name} нанёс урон противнику'
...
def special(char_name, char_class):
    if char_class == 'warrior':
        print(f'{char_name} применил специальное умение «Выносливость'
              '{80 + 25}»')
    if char_class == 'mage':
        print(f'{char_name} применил специальное умение «Атака {5 + 40}»')
    if char_class == 'healer':
        print(f'{char_name} применил специальное умение «Защита {10 + 30}»')
